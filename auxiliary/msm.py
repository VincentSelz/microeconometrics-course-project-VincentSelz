...
def params_description():
    ...
    'cost_of_effort','cost_of_effort','cost_of_effort','cost_of_effort','cost_of_effort','cost_of_effort','cost_of_effort','cost_of_effort','cost_of_effort','cost_of_effort','cost_of_effort','cost_of_effort'],
    'name':['lambda','std_lambda', 'phi_pi', 'varphi_pi', 'phi_mu', 'varphi_mu',
    'kappa', 'b','delta_2','delta_3','delta_4','delta_5','delta_6','delta_7','delta_8','delta_9','delta_10'],
    ...
    'common cost parameter','common cost parameter','round effects for round 2','round effects for round 3','round effects for round 4','round effects for round 5','round effects for round 6','round effects for round 7','round effects for round 8','round effects for round 9','round effects for round 10'],
...
def observed_moments(df):
    ...
    observed_moments = {
        ...
        'perc17_cond_corr_e2_e1timesprize': calc_moments['perc17_cond_corr_e2_e1timesprize'](df),
        'perc33_cond_corr_e2_e1timesprize': calc_moments['perc33_cond_corr_e2_e1timesprize'](df),
        'perc50_cond_corr_e2_e1timesprize': calc_moments['perc50_cond_corr_e2_e1timesprize'](df),
        'perc66_cond_corr_e2_e1timesprize': calc_moments['perc66_cond_corr_e2_e1timesprize'](df),
        'perc83_cond_corr_e2_e1timesprize': calc_moments['perc83_cond_corr_e2_e1timesprize'](df),
